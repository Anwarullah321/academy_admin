...
class _ViewMCQsPageState extends State<ViewMCQsPage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      provider.loadMCQs(widget.selectedClass, widget.selectedSubject, widget.selectedChapter);
    });
  }
                  ...
                  child: TextButton(
                    ...
                    onPressed: (isDeleting || isAllSelected)
                      ...
                      if (confirm) {
                        ...
                        try {
                          await provider.deleteMCQsByYear(
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                context.pop();
                await provider.deleteMCQ(widget.selectedClass, widget.selectedSubject, widget.selectedChapter, mcq.id);
              },
            ),
          ],
        );
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    context.go('/edit_mcq/${widget.selectedClass}/${widget.selectedSubject}/${widget.selectedChapter}/${mcq.id}');
                                  },
                                ),
                                IconButton(

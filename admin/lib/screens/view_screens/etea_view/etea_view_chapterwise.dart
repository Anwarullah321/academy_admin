...
class _ViewEteaMCQsPageState extends State<ViewEteaMCQsPage> {
  ...
  Future<void> _loadMCQs() async {
    final mcqs = await _getService.getEteaChapterwiseMCQs(
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              child: Text('Delete'),
              onPressed: () async {
                await _deleteService.deleteEteaChapterwiseMCQ(
                  widget.selectedSubject,
                  widget.selectedChapter,
                  mcq.id,
                );
                  ...
                  onPressed: _isDeleting
                    ...
                    if (selectedYearToDelete != null && selectedYearToDelete!.year != null) {
                      ...
                      if (confirm) {
                        ...
                        try {
                          await _deleteService.deleteEteaMCQsByYear(
                            widget.selectedSubject,
                            widget.selectedChapter,
                          ...
                          Navigator.of(context).pop();
                          await _loadMCQs(); // Refresh the data

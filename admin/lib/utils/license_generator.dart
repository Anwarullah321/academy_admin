...
class NexaSoftLicenseGenerator {
  static String envelopLicense(String purpose, String license){
    return "-----$purpose-----\n$license\n-----$purpose-----";
  }


static String removeEnvelop(String envelopedLicense) {
  return envelopedLicense

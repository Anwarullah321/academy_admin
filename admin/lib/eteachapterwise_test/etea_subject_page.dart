...
class SelecteateSubjectPage extends StatefulWidget {



  const SelecteateSubjectPage({Key? key, }) : super(key: key);

  @override
  _SelectSubjecteatePageState createState() => _SelectSubjecteatePageState();
}

class _SelectSubjecteatePageState extends State<SelecteateSubjectPage> {
  final GetService _getService = GetService();
  List<String> _subjects = [];
  Map<String, Color> _hoverColors = {};

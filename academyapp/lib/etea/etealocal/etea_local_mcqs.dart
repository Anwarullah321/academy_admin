import 'package:academyapp/etea/etealocal/ViewChapterwiseList.dart';
...
class EteaLocalMCQPage extends StatefulWidget {
  final List<MCQ> mcqs;
  ...
  @override
  _EteaLocalMCQPageState createState() => _EteaLocalMCQPageState();
}

class _EteaLocalMCQPageState extends State<EteaLocalMCQPage> {
  List<MCQ> _mcqs = [];

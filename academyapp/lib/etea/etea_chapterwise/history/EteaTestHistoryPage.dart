...
import 'EteaSingleTestDetailPage.dart';

class EteaChapterwiseTestHistoryPage extends StatefulWidget {
  final String subjectName;
  final String chapter;

  EteaChapterwiseTestHistoryPage({
    required this.subjectName,
    required this.chapter,
  });

  @override
  State<EteaChapterwiseTestHistoryPage> createState() => _EteaChapterwiseTestHistoryPageState();
}

class _EteaChapterwiseTestHistoryPageState extends State<EteaChapterwiseTestHistoryPage> {
  Key _futureBuilderKey = UniqueKey();

  Future<List<Map<String, dynamic>>> _getTestHistory() async {
    final prefs = await SharedPreferences.getInstance();
    final key = '${widget.subjectName}_${widget.chapter}_eteaobjective';
  ...
  void _showDetails(BuildContext context, Map<String, dynamic> item) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => EteaSingleTestDetailPage(testData: item),
      ),
    );
  }

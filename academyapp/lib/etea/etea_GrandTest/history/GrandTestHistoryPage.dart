...
import 'GrandTestSingleTestDetailPage.dart';





class GrandTestHistoryPage extends StatefulWidget {



  @override
  State<GrandTestHistoryPage> createState() => _GrandTestHistoryPageState();
}

class _GrandTestHistoryPageState extends State<GrandTestHistoryPage> {
  ...
  void _showDetails(BuildContext context, Map<String, dynamic> item) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GrandTestSingleTestDetailPage(testData: item),
      ),
    );
  }

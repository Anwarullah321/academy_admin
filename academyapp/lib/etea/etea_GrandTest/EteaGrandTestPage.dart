...
import 'GrandTestDetailResultPage.dart';


class EteaGrandTestPage extends StatefulWidget {
  final List<MCQ> mcqs;



  EteaGrandTestPage({required this.mcqs});


  @override
  _EteaGrandTestPageState createState() => _EteaGrandTestPageState();
}

class _EteaGrandTestPageState extends State<EteaGrandTestPage> {
  ...
  void initState() {
    ...
    _mcqs = widget.mcqs;
    _isLoading = false;
    print('MCQs loaded: ${_mcqs.length}');
  }
  ...
  void _showDetailedResults(int correctAnswers, int totalQuestions) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GrandTestDetailedResultsPage(
          mcqs: _mcqs,

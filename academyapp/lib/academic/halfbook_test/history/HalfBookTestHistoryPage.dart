...
import 'HalfBookSingleTestDatailPage.dart';



class HalfBookTestHistoryPage extends StatefulWidget {
  final String className;
  final String subjectName;

  HalfBookTestHistoryPage({
  ...
  @override
  State<HalfBookTestHistoryPage> createState() => _HalfBookTestHistoryPageState();
}

class _HalfBookTestHistoryPageState extends State<HalfBookTestHistoryPage> {
  ...
  void _showDetails(BuildContext context, Map<String, dynamic> item) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => HalfBookSingleTestDetailPage(testData: item),
      ),
    );
  }

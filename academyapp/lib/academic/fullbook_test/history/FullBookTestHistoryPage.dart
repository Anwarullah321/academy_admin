...
import 'FullBookSingleTestDetailPage.dart';



class FullBookTestHistoryPage extends StatefulWidget {
  final String className;
  final String subjectName;

  FullBookTestHistoryPage({
  ...
  @override
  State<FullBookTestHistoryPage> createState() => _FullBookTestHistoryPageState();
}

class _FullBookTestHistoryPageState extends State<FullBookTestHistoryPage> {
  Key _futureBuilderKey = UniqueKey();

  Future<List<Map<String, dynamic>>> _getTestHistory() async {
    final prefs = await SharedPreferences.getInstance();
    final key = '${widget.className}_${widget.subjectName}_objective';
  ...
  void _showDetails(BuildContext context, Map<String, dynamic> item) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => FullBookSingleTestDetailPage(testData: item),
      ),
    );
  }

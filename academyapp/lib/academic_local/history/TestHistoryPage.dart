...
import 'SingleTestDetailPage.dart';

class LocalTestHistoryPage extends StatefulWidget {
  final String selectedClass;
  final String selectedSubject;
  final String selectedChapter;

  LocalTestHistoryPage({
  ...
  @override
  State<LocalTestHistoryPage> createState() => _LocalTestHistoryPageState();
}

class _LocalTestHistoryPageState extends State<LocalTestHistoryPage> {
  ...
  void _showDetails(BuildContext context, Map<String, dynamic> item) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SingleTestDetailPage(testData: item),
      ),
    );
  }
